...
/**
 * Vergleiche 2 Vektoren der Dimension 3 mit einander. Liefert 1 wenn sie identisch sind
 */
extern int compareVec3(const GLfloat *vecA, const GLfloat *vecB);

/**
 * Vergleiche 2 Vektoren der Dimension 4 mit einander. Liefert 1 wenn sie identisch sind
 */
